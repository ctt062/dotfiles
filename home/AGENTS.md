...
Keep this file as the single source of truth for global agent policy.
Prefer rewriting or pruning existing entries over appending new ones.
Keep entries concise and actionable.

For Cursor specifically: `~/.cursor/AGENTS.md` alone is not a documented global rules source. This policy is loaded globally through:
